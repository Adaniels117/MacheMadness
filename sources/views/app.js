...
var mainToolbar = {
	...
	elements:[
		{view: "label", label: "<a href='http://www.google.com'><img class='photo' src='assets/imgs/logo.png' /></a>", width: 200},

		{ height:46, id: "person_template", css: "header_person", borderless:true, width: 180, data: {id:3,name: "AD Admin"},
