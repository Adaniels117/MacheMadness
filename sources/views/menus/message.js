		...
		rows:[
			{
				...
				data: [
					...
					{id: 3, name: "Kim Alley", text: "Lorem ipsum dolor sit amet", personId:4},
					{id: 4, name: "Jeremy O'Neal", text: "Morbi eget facilisis risus", personId:5},
					{id: 5, name: "Paul Jackson", text: "Cras lacinia bibendum arcu", personId:3}
				],
				type:{
					height: 45,
